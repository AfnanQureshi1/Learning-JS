...
const ele = document.getElementById('quiz-form')
...
checkedAnswers.forEach(answerss => {
    const istrue = answers.values === 'true'
    const questionItems= answers.closest(".question-items")
